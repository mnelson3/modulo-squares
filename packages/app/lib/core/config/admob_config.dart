...
class AdMobConfig {
  ...
  static const String iosAppId = 'ca-app-pub-xxxxxxxxxxxxxxxx~zzzzzzzzzz'; // REPLACE with your iOS App ID

  // Production Ad Unit IDs (REPLACE WITH YOUR ACTUAL AD UNIT IDs)
  static const String androidInterstitialId = 'ca-app-pub-5198775482699756/1234567890'; // REPLACE
  static const String iosInterstitialId = 'ca-app-pub-xxxxxxxxxxxxxxxx/1234567890'; // REPLACE
