...
class GameGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      label:
          'Game board with ${gameBoard.rows} rows and ${gameBoard.cols} columns',
            ...
            child: GestureDetector(
              ...
              onPanEnd: (details) {
                ...
                if (velocity.distanceSquared > 1000) {
                  ...
                  if (direction != null) {
                    onSlide(row, col, direction.$1, direction.$2);
                  }
                }
              },
              child: GridCellWidget(tile: tile, isSelected: isSelected),
            ),
          );
        },
      ),
  ...
  String _getTileAccessibilityHint(Tile tile, bool isSelected) {
    ...
    switch (tile.type) {
      case TileType.normal:
        return tile.value != null
            ? 'Tap to select this number tile'
            : 'Empty cell';
      case TileType.obstacle:
